...
public class GeographicPoint extends Double {
	...
	private double getDist2(double lat1, double lon1, double lat2, double lon2)
    {
//		System.out.println(Math.pow(lat2 - lat1, 2));
//		System.out.println(Math.pow(lon2 - lon1, 2));
//		System.out.println(Math.sqrt(Math.pow(lat2 - lat1, 2) + Math.pow(lon2 - lon1, 2)));
    	double d = Math.sqrt(Math.pow(lat2 - lat1, 2) + Math.pow(lon2 - lon1, 2));
    	return d;
    }
